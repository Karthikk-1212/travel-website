    ...
    <>
      ...
      <section className="relative h-[50vh] min-h-[360px] w-full">
        ...
        <div className="container relative z-10 flex h-full flex-col justify-end pb-10">
          ...
          <p className="mt-2 max-w-xl text-parchment-200/85">{dest.tagline}</p>
        </div>
      </section>
      ...
      <section className="bg-parchment-50 py-16">
        <div className="container grid grid-cols-1 gap-12 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <h2 className="font-display text-2xl font-semibold text-basalt-900">About {dest.name}</h2>
            <p className="mt-4 text-basalt-700">{dest.about}</p>

            <h3 className="mt-10 font-display text-xl font-semibold text-basalt-900">Travel Tips</h3>
          ...
          <aside className="space-y-8">
            <div className="rounded-card border border-basalt-600/15 bg-white p-6">
              <p className="text-xs uppercase tracking-widest text-basalt-500">Best Time to Visit</p>
            ...
            <div className="rounded-card border border-basalt-600/15 bg-white p-6">
              <p className="text-xs uppercase tracking-widest text-basalt-500">Nearby Attractions</p>
